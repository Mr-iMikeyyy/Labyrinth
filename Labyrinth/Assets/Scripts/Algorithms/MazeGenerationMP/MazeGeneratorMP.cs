...
public class MazeGeneratorMP : MonoBehaviour {
    ...
    private void BakeMesh() {
        ...
        MazeNavMeshBuilderMP navBuilder = navMesh.GetComponent<MazeNavMeshBuilderMP>();
    ...
    */
    void CreateRoom(List<MazeNode> nodes, List<MazeNode> completedNodes, int x, int y, bool is_center_room, int room, GameObject key) {
        ...
        if (centerLeft != null) {
            ...
            if (room == 1) {
                // for each player character in the scene, place them all in the room
