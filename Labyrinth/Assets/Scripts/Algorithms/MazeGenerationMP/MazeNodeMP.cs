...
public enum NodeStateMP {
    Available,
    Current,
    Completed
}

public class MazeNodeMP : MonoBehaviour {
...
public void AddChest() {
    ...
    public void SetState(NodeStateMP state) {
        switch (state) {
            case NodeStateMP.Available:
                // floor.material.color = Color.white;
                break;
            case NodeStateMP.Current:
                // floor.material.color = Color.yellow;
                break;
            case NodeStateMP.Completed:
