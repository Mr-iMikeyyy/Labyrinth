...
public class PauseMenuSettings : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        footsteps.volume = sfxSlider.value;
        sprintFootsteps.volume = sfxSlider.value;
    ...
    public void ResetSettings()
    {
        ...
        footsteps.volume = prevSFXVolume;
        sprintFootsteps.volume = prevSFXVolume;
